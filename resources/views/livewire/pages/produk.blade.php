            ...
            <main class="flex-1 p-4 sm:p-6 space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                    ...
                    <div class="space-x-2">
                        ...
                        <a href="{{ route('print.form') }}" class="hidden lg:inline-flex items-center gap-2 text-sm font-bold text-[#07E200] hover:text-white px-4 py-2.5 rounded-xl border border-[#07E200] hover:opacity-90 hover:bg-[#07E200] transition-all duration-200">
                        ...
                        <a href="{{ route('print.qrcode') }}" class="hidden lg:inline-flex items-center gap-2 text-sm font-bold text-[#07E200] hover:text-white px-4 py-2.5 rounded-xl border border-[#07E200] hover:opacity-90 hover:bg-[#07E200] transition-all duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
