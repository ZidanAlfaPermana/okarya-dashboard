<div x-data="{ sidebarOpen: false }">
    ...
    <aside
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            <p class="text-[10px] font-semibold uppercase tracking-widest text-gray-400 px-3 py-2">OTHER</p>
            <a href="{{ route('guide') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors {{ request()->routeIs('guide') ? 'bg-[#07E200]/10 text-[#07E200]' : 'text-gray-600 hover:bg-gray-50' }}">
                <span class="w-8 h-8 rounded-lg flex items-center justify-center {{ request()->routeIs('guide') ? 'bg-[#07E200] text-white' : 'bg-gray-100 text-gray-400' }}">
